...
- you have a working python installation based on mambaforge ([Unit 01](../week_01/02-Installation.ipynb)) or conda
...
week [01](../week_01/02-Installation.ipynb).
```
...
These instructions are useful for later in the class (when I'll ask you to install more packages) or maybe for other classes for which you may have to install packages. 
...
Visit the [conda documentation](https://conda.io/projects/conda/en/latest/user-guide/getting-started.html#managing-environments) for more commands (just replace all "`conda`" commands with "`mamba`").
