...
Ideally you will have the programming level of a student having completed [the introduction to programming for atmospheric scientists](https://lfuonline.uibk.ac.at/public/lfuonline_lv.details?sem_id_in=24S&lvnr_id_in=707638&sprache_in=en) in the BSc.
The first few units will be catching up on the materials from the BSc class, but quickly enough we will move towards more advanced topics.
...
1. The mid-term exam (open-book exam, combination of muliple choice, essay, and programming questions) will take place on **Tuesday 5.11.2024** from 10:15 to 12:00.
2. The final exam (open-book exam, combination of muliple choice, essay, and programming questions) will take place on **Tuesday 14.01.2025** from 10:15 to 12:00.
